...
//	groundSprite=createSprite(width/2, height-35, width,10);
	...
	rect1 = Bodies.rectangle(400,690,200,20 , {isStatic:true} );
    World.add(world, rect1);
	 
	rect2 = Bodies.rectangle(290,650,20,150 , {isStatic:true} );
	 World.add(world, rect2);
	 
    rect3 = Bodies.rectangle(490,650,20,150 , {isStatic:true} );
